...
def test_2022_TdF():
    ...
    assert results_2022.results_table['Rider'].iloc[0] == 'Vingegaard Jonas'
    ...
    assert results_st1.results_table['Rider'].iloc[0] == 'Lampaert Yves'
